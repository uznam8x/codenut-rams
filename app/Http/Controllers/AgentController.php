...
class AgentController extends Controller {
    use Response;
    private $validate = array('store' => 'required|string|max:255|unique:cr_agent', 'addon' => 'string');

    public function create(Request $request) {
        $param = $request->only( ['store', 'addon'] );
        ...
        // create store table
        Schema::create( 'cr_store_' . $param['store'], function(Blueprint $table) {
